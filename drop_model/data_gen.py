...
def main():
    ...
    for i in range(1):
        ...
        drop_viz.plot_height_profile_evolution(r_lin, h_history[::10], params)
    ...
    torch.save(results, "data/mdm_sim_cap_6.pth")
